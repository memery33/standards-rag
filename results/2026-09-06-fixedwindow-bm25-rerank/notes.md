# fixedwindow-bm25-rerank

Reranking variable only, on top of fixedwindow-bm25. Tests whether reranking rescues the naive chunker.
...
|---|---|---|---|---|---|
| 1 | 0.64 | 1.0 | 1.0 | 0.2433 | yes |
| 3 | 0.8 | 1.0 | 1.0 | 0.5595 | yes |
| 5 | 0.92 | 1.0 | 1.0 | 0.7409 | yes |
| 10 | 1.0 | 1.0 | 1.0 | 0.9606 | yes |
...
- mean latency: 0.00175s, p95 0.00252s
- mean tokens per query: 906.6
...
- `r005` cited ['ITCP Fundamentals', 'ITCP Fundamentals > Why ITCPs exist']
