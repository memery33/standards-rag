...
Chunking variable only: section-aware instead of fixed window. Retriever, generator and threshold identical to fixedwindow-bm25.
...
- mean latency: 0.00079s, p95 0.00137s
- mean tokens per query: 624.7

## Questions failing recall_strict@3 (8)
...
- `q017` [synthesis] Which equipment has significant rear blind spots, and what is required of operators because of it?
  gold: ITCP Fundamentals > Operation templates (example diagrams in the source) > Asphalt milling; ITCP Fundamentals > Personnel responsibility matrix (summarized); ITCP Fundamentals > Why ITCPs exist
...
- `r005` cited ['ITCP Fundamentals > What an ITCP is', 'ITCP Fundamentals > Other considerations > Worker visibility', 'ITCP Fundamentals > Operation templates (example diagrams in the source) > Dirt spreading (limited backing distance)']
